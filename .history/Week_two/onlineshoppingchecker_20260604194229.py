...
payment = float(input("What is the amount on your valid payment method? "))
if items_in_cart_input > 0 and payment > 0:
    print("You can check out")
else: print("Cannot check out because you either have no items in cart or you do not have a valid payment")

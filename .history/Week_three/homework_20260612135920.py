...
#third homework Given two lists: colors = ['blue', 'green', 'yellow'] and objects = ['car', 'house', 'shirt'], use a
nested loop to combine them. Skip any combination where the color is 'green'.

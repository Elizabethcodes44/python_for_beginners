...
for scores in scores1:
      for new_scores in scores2:
            total_scores = scores + new_scores
            #printing the sum of each pair
            print(total_scores)
            #checking scores that re greater than 30 
            if total_scores > 30 :
                   #printing the scores 
                   print(f"these are the toatl scores greater than 30: {total_scores}")

#fifth Using nested loops, print a pattern of stars (*) in a square shape of size 5x5. Then modify it to print only the diagonal stars.
